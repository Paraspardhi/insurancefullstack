...
<body>
	...
	<div class="box">
		...
		<br> <a class="button" href="addAuthorities.jsp">Add
			...
			<form action="getAuthorityInsurance" method="get">
					<input type="text" placeholder="Authority name" id="Provider" name="provider">
			
			<input type="submit" value="GetClientInsurance" >
			</form>
		<br>
		<br> 
